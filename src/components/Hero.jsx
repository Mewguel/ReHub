  ...
  return (
    <div className="md:flex hero-text-container text-rehub-deepblue" id="hero">
      <div className="max-w-[800px] mt-[-90px] w-full h-screen mx-auto text-center flex flex-col justify-center">
        <h6 className="text-rehub-cerulean md:text-7xl sm:text-5xl  text-4xl font-bold p-2">
          RE-HUB
        </h6>
        <div className="flex justify-center items-center">
          <Typed
            className="md:text-xl sm:text-lg text-base font-semibold pl-2 text-rehub-orange"
        ...
        <div className="p-5 ">
          <Link
            href="/"
            className="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-rehub-cerulean border-2 border-rehub-cerulean rounded-full hover:text-white group hover:bg-gray-50"
          >
            <span className="absolute left-0 block w-full h-0 transition-all bg-rehub-cerulean opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
